...
def add_message():
    ...
    if request.is_json:
        ...
        if len(recent_cam_messages) > 2:
            ...
            amalgamated_topDown_map = sfn.generate_amalgamated_topDown_map(topDown_maps,
                                                                           config_for_amalgamation)
            ...
            crowd_density_global = sfn.create_obs_message(amal_cam_ids, amal_density_count,
                                                          amalgamated_topDown_map,
