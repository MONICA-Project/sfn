...
def work(width, height, buffer, seq_id, settings):
    ...
    if seq_id in settings.keys():
        ...
        message, density_map = crowd_density_analyzer.process_frame(rgb,camera_settings['camera_bearing'],camera_settings['camera_position'],camera_settings['camera_id'],camera_settings['crowd_mask'],camera_settings['image_2_ground_plane_matrix'],camera_settings['ground_plane_roi'],camera_settings['ground_plane_size'])
